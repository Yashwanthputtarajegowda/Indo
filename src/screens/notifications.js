...
function renderNotification(item) {
  ...
  return `<article class="indo-notice-card ${unread ? "is-unread" : "is-read"}" data-notification-id="${escapeHtml(item.id || "")}" data-actor-uid="${actorUid}" data-actor-user-id="${actorUserId}">
    ...
    <div class="indo-notice-copy"><div class="indo-notice-line"><b>${actor}</b><span>${message}</span></div><div class="indo-notice-meta"><span>${actorName}</span><span>•</span><time>${timeAgo(item.createdAt)}</time></div></div>
...
function installStyles() {
  ...
  style.id = STYLE_ID;
  style.textContent = `.indo-notifications-shell{min-height:100vh;background:#030307;color:#f7f4fb;display:flex;flex-direction:column}.indo-notifications-shell .indo-option5-topbar{position:sticky;top:0;z-index:40}.indo-notifications-main{width:100%;max-width:760px;margin:0 auto;padding:18px 12px 92px;box-sizing:border-box;background:radial-gradient(circle at 50% 0%,rgba(152,59,255,.09),transparent 33%),linear-gradient(180deg,#05050a 0%,#030307 100%)}.indo-notifications-heading{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:6px 4px 14px;border-bottom:1px solid rgba(176,91,255,.22)}.indo-notifications-title{margin:0;font:800 24px/1.05 Arial,sans-serif;letter-spacing:-.4px;color:#fff}.indo-notifications-readall{border:0;background:transparent;color:#ff35b5;font:800 12px/1 Arial,sans-serif;padding:8px 0;cursor:pointer}.indo-notifications-list{display:flex;flex-direction:column;gap:9px;padding-top:11px}.indo-notice-card{position:relative;display:grid;grid-template-columns:10px 48px minmax(0,1fr) auto;align-items:center;gap:10px;min-height:82px;padding:10px 10px 10px 8px;border:1px solid rgba(135,69,222,.42);border-radius:13px;background:linear-gradient(145deg,rgba(18,15,27,.96),rgba(8,8,14,.98));box-sizing:border-box}.indo-notice-card.is-read{border-color:rgba(88,78,108,.34)}.indo-notice-unread-dot{width:7px;height:7px;border-radius:999px;background:#3a3743;justify-self:center}.indo-notice-card.is-unread .indo-notice-unread-dot{background:#ff2fad;box-shadow:0 0 10px rgba(255,47,173,.65)}.indo-notice-avatar{position:relative;width:46px;height:46px;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 30% 25%,#324257,#1b2431 66%,#121722);color:#fff;font:900 18px/1 Arial,sans-serif;overflow:hidden}.indo-notice-avatar .indo-live-avatar-img{position:absolute;inset:0}.indo-notice-kind{position:absolute;right:-4px;bottom:-3px;width:21px;height:21px;border-radius:50%;display:grid;place-items:center;color:#fff;font:800 10px/1 Arial,sans-serif;border:2px solid #08080d}.indo-notice-copy{min-width:0;display:flex;flex-direction:column;gap:5px}.indo-notice-line{display:flex;align-items:baseline;gap:6px;min-width:0;color:#f4f1f6;font-size:13px;line-height:1.22}.indo-notice-line b{font-weight:900;color:#fff;white-space:nowrap}.indo-notice-line span{color:#d6d0dc;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.indo-notice-meta{display:flex;align-items:center;gap:5px;color:#8d8795;font:600 10px/1.2 Arial,sans-serif}.indo-notice-end{display:flex;align-items:center;justify-content:flex-end;min-width:62px}.indo-notice-action{border:1px solid #ff34b4;background:rgba(255,45,178,.07);color:#ff43b9;border-radius:9px;padding:8px 10px;font:800 10px/1 Arial,sans-serif;cursor:pointer;white-space:nowrap}.indo-notice-kind-follow{background:linear-gradient(145deg,#8d42ff,#5f30ff)}.indo-notice-kind-comment{background:linear-gradient(145deg,#ff49a7,#ff1f86)}.indo-notice-kind-like{background:linear-gradient(145deg,#ff55b7,#ef1889)}.indo-notice-kind-save{background:linear-gradient(145deg,#9d50ff,#7f36ff)}.indo-notifications-empty{padding:36px 14px;text-align:center;color:#7f7887;font:600 13px/1.45 Arial,sans-serif;border:1px dashed rgba(122,98,152,.3);border-radius:12px;margin-top:12px}.indo-notifications-status{color:#77707f;font:600 12px/1.4 Arial,sans-serif;padding:12px 2px}@media(max-width:420px){.indo-notifications-main{padding:12px 7px 92px}.indo-notice-card{grid-template-columns:8px 42px minmax(0,1fr) auto;gap:8px;min-height:74px;padding:8px 8px 8px 6px;border-radius:11px}.indo-notice-avatar{width:40px;height:40px;font-size:16px}.indo-notice-kind{width:19px;height:19px;font-size:9px}.indo-notice-line{font-size:11px;gap:4px}.indo-notice-meta{font-size:9px}.indo-notice-end{min-width:52px}.indo-notice-action{padding:7px 7px;font-size:8px}}`;
