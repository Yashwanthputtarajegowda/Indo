...
function installStyles() {
  ...
  s.id = STYLE_ID;
  s.textContent = `.indo-upload-shell{min-height:100vh;background:radial-gradient(circle at 50% -8%,rgba(125,35,255,.2),transparent 30%),#030308;color:#fff;padding-bottom:82px}.indo-upload-head{height:58px;display:grid;grid-template-columns:44px 1fr 44px;align-items:center;padding:0 12px;border-bottom:1px solid rgba(145,88,255,.16);background:rgba(4,4,9,.94);position:sticky;top:0;z-index:8;backdrop-filter:blur(18px)}.indo-upload-head button{width:38px;height:38px;border:1px solid rgba(164,80,255,.22);border-radius:50%;background:rgba(122,39,255,.1);color:#fff;display:grid;place-items:center}.indo-upload-head h2{margin:0;text-align:center;font-size:17px;font-weight:850}.indo-upload-main{padding:15px 12px 24px}.indo-upload-label{font-size:11px;color:#aaa8b8;margin:2px 0 8px}.indo-video-preview{height:190px;border-radius:15px;border:1px solid #392257;background:linear-gradient(145deg,#171126,#080811);display:grid;place-items:center;overflow:hidden;position:relative;box-shadow:0 12px 30px rgba(0,0,0,.25)}.indo-video-preview video{width:100%;height:100%;object-fit:cover}.indo-preview-placeholder{display:grid;place-items:center;gap:7px;color:#a9a5b6}.indo-preview-placeholder b{font-size:34px;color:#a238ff;text-shadow:0 0 20px #8e2cff}.indo-thumb-row{display:flex;gap:8px;margin:8px 0 16px}.indo-thumb{height:55px;flex:1;border-radius:9px;border:1px solid #35234e;background:#0d0d17;color:#b4afc0;display:grid;place-items:center;font-size:10px}.indo-thumb.active{border:2px solid #a72cff;color:#fff}.indo-upload-section-title{font-size:11px;color:#aaa8b8;margin:12px 0 7px}.indo-upload-field{margin-bottom:9px}.indo-upload-field label{display:block;font-size:10px;color:#b6b2c0;margin-bottom:5px}.indo-upload-field input,.indo-upload-field textarea{width:100%;border:1px solid #2d2441;border-radius:10px;background:#0d0d17;color:#fff;outline:none;padding:11px;font-size:11px;box-sizing:border-box}.indo-upload-field textarea{min-height:92px;resize:none}.indo-upload-field input:focus,.indo-upload-field textarea:focus{border-color:#a43cff;box-shadow:0 0 14px rgba(135,45,255,.12)}.indo-more-box{min-height:92px;display:flex;align-items:flex-start;box-sizing:border-box}.indo-more-box::placeholder{color:#777381}.indo-upload-row{width:100%;display:flex;align-items:center;justify-content:space-between;padding:13px 4px;border:0;border-bottom:1px solid #1d1928;background:transparent;color:#fff;font-size:11px;text-align:left}.indo-upload-row.clickable{cursor:pointer}.indo-upload-row .label{display:flex;align-items:center;gap:7px;min-width:0}.indo-upload-row .value{color:#a9a5b5;display:flex;align-items:center;gap:6px;white-space:nowrap}.indo-toggle{width:37px;height:21px;border-radius:20px;background:#33313a;padding:2px;display:flex;justify-content:flex-start;box-sizing:border-box}.indo-toggle.on{background:#7d35ff;justify-content:flex-end}.indo-toggle i{width:17px;height:17px;border-radius:50%;background:#fff}.indo-upload-hint{color:#8b8792;font-size:8px;padding:8px 4px 0}.indo-upload-primary{width:100%;height:45px;margin-top:16px;border:0;border-radius:11px;background:linear-gradient(100deg,#8035ff,#df22c9);color:#fff;font-size:13px;font-weight:850;box-shadow:0 10px 24px rgba(164,38,238,.25)}.indo-upload-message{min-height:17px;text-align:center;color:#aaa7b6;font-size:10px;margin:7px 0}.indo-upload-progress{height:4px;border-radius:10px;background:#211a2e;overflow:hidden}.indo-upload-progress span{display:block;height:100%;width:0;background:linear-gradient(90deg,#8035ff,#ff22c4);transition:width .2s}@media(max-width:380px){.indo-video-preview{height:165px}.indo-upload-main{padding:12px 9px 20px}}`;
