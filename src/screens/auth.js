export function renderLogin(app) {
  app.innerHTML = `
    <main class="auth-page indo-auth-v144">
        ...
        <section class="auth-card">
          ...
          <form id="login-form" class="auth-form">
            <label class="auth-field">
              ...
              <div class="auth-input-wrap"><input id="login-email" type="email" placeholder="Enter your email" autocomplete="email" required><b aria-hidden="true">✉</b></div>
            </label>
            <label class="auth-field">
              <span><i aria-hidden="true">♙</i>Password</span>
              <div class="auth-input-wrap"><input id="login-password" type="password" placeholder="Enter your password" autocomplete="current-password" required><button class="auth-eye" id="login-password-toggle" type="button" aria-label="Show password">◉</button></div>
            </label>
  ...
  app.innerHTML = `
    <main class="auth-page indo-auth-v144">
      ...
      <section class="auth-login-stage auth-signup-stage">
        ...
        <section class="auth-card">
          <div class="auth-welcome"><div class="auth-wave">✨</div><h1>Create account</h1><p>Choose your Indo identity and start sharing.</p></div>
          <form id="signup-form" class="auth-form">
            <label class="auth-field"><span>Username</span><div class="auth-input-wrap"><input id="signup-username" placeholder="Your name" autocomplete="nickname" required></div></label>
            <label class="auth-field"><span>User ID</span><div class="auth-input-wrap"><input id="signup-user-id" placeholder="@yourid" autocomplete="username" required></div><small id="user-id-message" class="auth-hint">@ is required. After @, choose any User ID you want.</small></label>
            ...
            <label class="auth-field"><span>Password</span><div class="auth-input-wrap"><input id="signup-password" type="password" placeholder="Create a password" autocomplete="new-password" minlength="8" required><button class="auth-eye" id="signup-password-toggle" type="button" aria-label="Show password">◉</button></div></label>
