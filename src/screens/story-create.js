  ...
  app.innerHTML = `
    <div class="app-shell">
      ...
      <main class="story-editor">
        ...
        <div class="story-preview-wrap"><div id="story-preview" class="story-preview"><video id="story-preview-video" autoplay playsinline muted></video><div id="story-title-overlay" class="story-title-overlay" hidden></div><img id="story-sticker-overlay" class="story-sticker-overlay" alt="" hidden></div></div>
