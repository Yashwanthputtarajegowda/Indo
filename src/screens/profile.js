...
export function renderProfile(app, profile = null) {
  ...
  loadProfileMedia().then(({ profile: latestProfile, videos }) => {
    ...
    postCount.textContent = String(count);
