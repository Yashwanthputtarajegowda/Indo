...
export function renderCreate(app) {
  app.innerHTML = `<div class="app-shell"><header class="page-head"><button data-screen="home">${icons.back}</button><h2>Create</h2><span></span></header><main class="create-page">
    <section class="create-card upload-video-card" style="display:grid;grid-template-columns:45px minmax(0,1fr) 132px;align-items:center;gap:12px;"><div class="create-icon">▣</div><div class="create-copy" style="min-width:0;"><b>Upload Video</b><small>Choose a video, add a caption and publish it.</small></div><input id="video-file" type="file" accept="video/*" hidden><button class="primary-btn create-select" type="button" data-select-video>Select</button></section>
    ...
    <section class="create-card" style="display:grid;grid-template-columns:45px minmax(0,1fr) 132px;align-items:center;gap:12px;"><span class="create-icon blue">◉</span><div class="create-copy" style="min-width:0;"><b>Story</b><small>Video story that expires after 24 hours.</small></div><input id="story-file" type="file" accept="video/*" hidden><button class="primary-btn create-story-select" type="button">Select</button></section>
