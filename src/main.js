...
async function openSharedStoryFromUrl() {
  ...
  try {
    ...
    console.warn('Shared story open failed:', error);
  }
}
...
function bindNavigation() {
  if (window.__indoNavigationBoundV130) return;
  window.__indoNavigationBoundV130 = true;
