...
const routerWarmup = import("./router.js?v=20260820-drive-resumable-v3").catch((error) => {
...
async function render() {
  ...
  const { render } = warmedRouter || await import("./router.js?v=20260820-drive-resumable-v3");
  await render(app);
