...
async function installLiveAvatars(){
  try{ await import('./features/profile/profile-avatar-live.js?v=20260815-avatar-v4'); }catch(error){ console.warn('Live profile avatars unavailable:',error); }
}
...
async function start(){
  ...
  started=true;
  try{
    const{auth}=await import('./features/auth/firebase-client.js?v=20260815-auth-v3');
