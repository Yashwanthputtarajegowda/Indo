...
function ensureFeedDesignStyles() {
  ...
  `;
    ...
    .video-post.neon-edge-post{
      ...
      box-shadow:0 0 0 1px rgba(137,92,255,.16),0 0 24px rgba(224,56,216,.22),0 16px 44px rgba(0,0,0,.28);
    }
    .video-post.neon-edge-post .neon-edge-head{
      min-height:58px;padding:8px 10px;background:rgba(10,10,16,.96);
      border-bottom:1px solid rgba(170,102,255,.22);backdrop-filter:blur(10px);
    }
    .video-post.neon-edge-post .neon-edge-creator{gap:9px}
    .video-post.neon-edge-post .neon-edge-avatar{
      width:36px;height:36px;min-width:36px;border:1px solid rgba(204,135,255,.75);
      box-shadow:0 0 12px rgba(175,89,255,.3);
    }
    .video-post.neon-edge-post .neon-edge-name{font-size:13px;letter-spacing:.1px}
    .video-post.neon-edge-post .neon-edge-follow{
      display:inline-flex;align-items:center;justify-content:center;height:32px;padding:0 13px;margin-left:auto;
      border:1px solid rgba(206,105,255,.85);border-radius:999px;color:#fff;
      ...
      font:800 11px/1 system-ui,sans-serif;letter-spacing:.35px;cursor:pointer;white-space:nowrap;
    }
    .video-post.neon-edge-post .neon-edge-follow:hover{border-color:#fff;box-shadow:0 0 14px rgba(222,130,255,.35)}
    .video-post.neon-edge-post .neon-edge-more{
      width:34px;height:34px;margin-left:8px;background:rgba(18,18,27,.72);
      border:1px solid rgba(255,255,255,.08);box-shadow:0 0 10px rgba(111,77,255,.12);
    }
    .video-post.neon-edge-post .neon-video-stage{
      position:relative;overflow:hidden;aspect-ratio:4/5;min-height:340px;max-height:70vh;background:#000;isolation:isolate;
    }
    .video-post.neon-edge-post .neon-video-stage::before{
      content:'';position:absolute;inset:0;z-index:1;pointer-events:none;
      background:linear-gradient(180deg,rgba(0,0,0,.02),rgba(0,0,0,.04) 46%,rgba(0,0,0,.48)),radial-gradient(circle at 82% 12%,rgba(255,75,205,.16),transparent 28%),radial-gradient(circle at 10% 86%,rgba(69,194,255,.10),transparent 26%);
    ...
    .video-post.neon-edge-post .neon-video-stage .post-video{
      position:relative;z-index:0;width:100%;height:100%;min-height:100%;object-fit:cover;object-position:center;background:#000;
    }
    .video-post.neon-edge-post .neon-edge-actions{
      grid-template-columns:repeat(4,minmax(0,1fr));min-height:58px;background:rgba(8,8,13,.98);border-top:1px solid rgba(226,51,207,.22);
    }
    .video-post.neon-edge-post .neon-edge-actions button{
      height:58px;gap:6px;color:#e2e2eb;font-size:11px;transition:color .16s ease,transform .16s ease,background .16s ease;
    }
    .video-post.neon-edge-post .neon-edge-actions button:hover{background:linear-gradient(180deg,rgba(120,67,255,.08),rgba(255,55,201,.03));transform:translateY(-1px)}
    .video-post.neon-edge-post .neon-edge-actions button svg{width:22px;height:22px;filter:drop-shadow(0 0 5px rgba(181,92,255,.18))}
    .video-post.neon-edge-post .neon-edge-actions small{font-size:10px;font-weight:800;letter-spacing:.15px}
    .video-post.neon-edge-post .neon-edge-copy{padding:10px 12px 13px;background:#07070c;border-top:1px solid rgba(255,255,255,.04)}
  ...
  */
  ...
  return `
    ...
    >
      ...
      <div class="neon-video-stage">${source}</div>
