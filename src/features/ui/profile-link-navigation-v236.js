...
function findIdentityTarget(element) {
  ...
  const selectors = [
    ...
    '.indo-story-card', '.watch-creator', '.creator-user', '.post-creator', '.creator',
    '.video-creator', '.video-creator-name', '.video-author', '.profile-direct-user-link',
    '.profile-user-id', '.profile-username', '[class*="user-id"]', '[class*="username"]',
    '[class*="creator"]', '[class*="author"]'
  ];
