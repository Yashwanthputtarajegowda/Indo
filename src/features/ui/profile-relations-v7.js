...
function styleOnce() {
  ...
  style.textContent = `
    ...
    .indo-rel-v7-head{height:56px;flex:0 0 56px;display:flex;align-items:center;justify-content:space-between;padding:0 16px;border-bottom:1px solid #24242b;color:#fff}
    .indo-rel-v7-head strong{font-size:15px}.indo-rel-v7-close{width:34px;height:34px;border:0;border-radius:50%;background:#1b1b22;color:#fff;font-size:22px;cursor:pointer}
    .indo-rel-v7-list{flex:1;overflow:auto;padding:8px}.indo-rel-v7-row{width:100%;display:flex;align-items:center;gap:12px;padding:11px 10px;min-height:60px;border:0;border-radius:10px;background:transparent;color:#fff;text-align:left;cursor:pointer}.indo-rel-v7-row:hover{background:#1a1a21}
    .indo-rel-v7-avatar{width:40px;height:40px;min-width:40px;border-radius:50%;display:grid;place-items:center;background:#2a2a31;font-weight:800}.indo-rel-v7-name{font-size:13px;font-weight:700;line-height:1.2}.indo-rel-v7-id{font-size:11px;color:#92929d;margin-top:2px}.indo-rel-v7-empty{padding:36px 16px;text-align:center;color:#8d8d98;font-size:13px}
  `;
...
async function refreshStats(root = document.getElementById('root')) {
  ...
  if (!targetUid) return;
  if (root.dataset.profileRelationsV7Uid === targetUid) return;
