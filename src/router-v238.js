...
import { renderLogin, renderSignup } from './screens/auth.js?v=238';
...
const VERSION = '238';
const NAV_STYLE_ID = 'indo-global-nav-v238';
...
export async function render(app) {
  try {
    switch (state.screen) {
      ...
      case 'profile': await renderLazy(app, './screens/profile-direct-v237.js', 'renderProfile', [state.profile]); break;
