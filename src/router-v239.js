...
import { renderLogin, renderSignup } from './screens/auth.js?v=239';
...
const VERSION = '239';
const NAV_STYLE_ID = 'indo-global-nav-v239';
...
export async function render(app) {
  try {
    switch (state.screen) {
      ...
      case 'profile': await renderLazy(app, './screens/profile-clean-v239.js', 'renderProfile', [state.profile]); break;
